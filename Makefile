DB_URL=postgresql://root:12345678@localhost:5432/simple_bank?sslmode=disable
...
.PHONY: postgres createdb dropdb migrateup migratedown migrateup1 migratedown1 sqlc test server mock dockerbuild dockerrun db_docs db_schema